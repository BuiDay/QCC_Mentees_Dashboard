                            ...
                            <div className='flex flex-col gap-5 h-full'>
                                ...
                                <div className='w-full h-full bg-white rounded-2xl shadow-md'>
                                    <div className='p-[40px] relative h-full flex justify-around items-center'>
                                        ...
                                        <div className=''>
                                            <div className='h-[150px] w-[150px] flex items-center justify-center rounded-full overflow-hidden'>
                                                <div className='h-[145px] w-[145px] bg-white rounded-full flex flex-col items-center justify-center'>
                                                    <p>Điểm tổng kết</p>
